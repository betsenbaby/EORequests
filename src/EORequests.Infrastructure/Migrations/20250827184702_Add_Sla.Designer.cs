...
namespace EORequests.Infrastructure.Migrations
{
    ...
    [Migration("20250827184702_Add_Sla")]
    partial class Add_Sla
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EORequests.Domain.Entities.SlaRule", b =>
                {
                    ...
                    b.Property<int?>("EscalationOffsetDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EORequests.Domain.Entities.SlaRule", b =>
                {
                    b.HasOne("EORequests.Domain.Entities.WorkflowStepTemplate", "WorkflowStepTemplate")
                        .WithOne("SlaRule")
                        .HasForeignKey("EORequests.Domain.Entities.SlaRule", "WorkflowStepTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
